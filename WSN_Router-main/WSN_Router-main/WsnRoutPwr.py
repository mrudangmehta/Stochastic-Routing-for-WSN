...
def main_menuR():
    ...
    rout_speed.add_command(label="medium", command=lambda: change_rout_speed(0.3))
    rout_speed.add_command(label="slow", command=lambda: change_rout_speed(1.0))
